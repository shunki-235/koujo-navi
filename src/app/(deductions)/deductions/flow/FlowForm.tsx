      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4 max-w-3xl">
          ...
          <label className="flex flex-col text-sm gap-1">
            <span>年度</span>
            <select className="border px-2 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("taxYear", { setValueAs: (v) => Number(v) as TaxYear })} defaultValue={2024}>
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.totalIncome} aria-describedby="totalIncome-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("totalIncome", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.medicalPaid} aria-describedby="medicalPaid-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("medicalPaid", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.medicalReimbursed} aria-describedby="medicalReimbursed-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("medicalReimbursed", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.socialPaid} aria-describedby="socialPaid-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("socialPaid", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.idecoPaid} aria-describedby="idecoPaid-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("idecoPaid", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.sbmPaid} aria-describedby="sbmPaid-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("sbmPaid", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.lifeGeneral} aria-describedby="lifeGeneral-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("lifeGeneral", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.lifePension} aria-describedby="lifePension-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("lifePension", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.lifeMedical} aria-describedby="lifeMedical-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("lifeMedical", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.lifeOld} aria-describedby="lifeOld-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("lifeOld", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.quakePaid} aria-describedby="quakePaid-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("quakePaid", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.quakeOld} aria-describedby="quakeOld-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("quakeOld", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            ...
            <input type="text" inputMode="numeric" aria-invalid={!!errors.donationHome} aria-describedby="donationHome-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("donationHome", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
          ...
          <label className="flex flex-col text-sm gap-1">
            <span>その他寄附</span>
            <input type="text" inputMode="numeric" aria-invalid={!!errors.donationOther} aria-describedby="donationOther-error" className="border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200" {...register("donationOther", { setValueAs: toIntOrNull })} onFocus={onCurrencyFocus} onBlur={onCurrencyBlur} />
        ...
        <div className="flex items-center gap-3">
          {step > 0 && (
            <button
              ...
              className="inline-flex items-center border px-4 py-2 text-sm hover:bg-gray-50"
            >
              戻る
            </button>
          )}
          {step < steps.length - 1 && (
            <button
              ...
              className="inline-flex items-center text-gray-900 underline underline-offset-4 px-0 py-2 text-sm hover:opacity-70"
            >
              次へ
            </button>
          )}
          {step === steps.length - 1 && (
            <button disabled={isPending} className="inline-flex items-center text-gray-900 underline underline-offset-4 px-0 py-2 text-sm disabled:opacity-70">
              {isPending ? "計算中..." : "計算する"}
            </button>
          )}
